...
<?php $__env->startSection('content'); ?>
    ...
    <p class="download-brochure" ><a href="#" target="_blank" download="Product-Brochure.pdf"><button class="btn btn-primary btn-lg " type="button"><?php echo e(__('messages.brochuer')); ?></button></a></p> 
