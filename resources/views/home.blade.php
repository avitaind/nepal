...
@section('content')
    ...
    <p class="download-brochure" ><a href="/images/AVITA-Nepal-Product-Brochure.pdf" target="_blank" download="AVITA-Nepal-Product-Brochure.pdf"><button class="btn btn-primary btn-lg " type="button">{{ __('messages.brochuer') }}</button></a></p> 
