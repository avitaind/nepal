...
@section('content')
    ...
    <p class="download-brochure" ><a href="#" target="_blank" download="Product-Brochure.pdf"><button class="btn btn-primary btn-lg " type="button">{{ __('messages.brochuer') }}</button></a></p> 
