                ...
                <div class="col-12 col-md-3 py-3 py-md-0 text-left">
                    <div class="d-flex justify-content-between hidden-xs-down">
                        <div class="d-flex flex-column mr-3 ml-md-0 small-lsm-little">
                            ...
                            <a target="_blank" class="my-1">NEXSTMALL</a>
                            <a target="_blank" class="my-1">Flipkart</a>
                            <a target="_blank" class="my-1">Amazon</a>
                            <a target="_blank" class="my-1">Paytm Mall</a>
                            <a target="_blank" class="my-1">TATA Cliq</a>
                        </div>
                    </div>
