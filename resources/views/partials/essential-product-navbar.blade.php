<div class="nav-product-panel">
    <div class="container">
        ...
        <div class="product-nav-collapse">
            ...
            <li class="nav-item"><a class="nav-link py-1" href="{{ route('product.overview', 'essential') }}">@lang('site.essential')</a></li>
            <li class="nav-item"><a class="nav-link py-1" href="{{ route('product.spec', 'essential') }}">@lang('site.essential_spec')</a></li>
